...
# def append_to_created_automation_run(
#     project_id, data_file="results/test-results.xml", headers=None
# ):

#     url = (
#         f"{TESTMO_URL}/api/v1/automation/runs/threads/{automation_run_thread_id}/append"
#     )
#     if headers is None:
#         headers = {"Authorization": f"Bearer {TESTMO_TOKEN}"}
...
# automation_run_thread_id = "8"
# project_id = "1"
# data_file = "results/test-results.xml"

# # Create the automation run
# # run_details = create_automation_run(project_id, data_file)
# append_to_created_automation_run(project_id, data_file)
